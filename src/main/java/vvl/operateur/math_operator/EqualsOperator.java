...
public class EqualsOperator implements Operator {
    ...
    public Object apply(ConsList<Object> operandes) throws LispError {
         ...
         double list = initializeAndSetList(lisp,true,null);
         ...
         while(lisp != ConsListFactory.nil()) {
             ...
             list =  initializeAndSetList(lisp,false,res);
             lisp = (Demo<Object>) lisp.cdr();
         }
             
         return  LispBoolean.TRUE;
 	}
    private double initializeAndSetList(Demo<Object> lisp, boolean init,Object res) throws LispError {
    	double list;
    	if(lisp.size() == 0)
